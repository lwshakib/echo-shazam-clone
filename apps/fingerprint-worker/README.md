...
```env
SERVER_URL=http://localhost:4000/webhook/upload_hashes
JWT_SECRET=your_secure_secret
AUDIO_DIR=../../audios
RESULTS_FILE=../../fingerprints.json
```
...
Scans the root `/audios` directory and uploads fingerprints for all discovered tracks to the database:
```bash
